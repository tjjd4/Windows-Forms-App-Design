...
namespace PresentationModel
{
    public class Form1 : Form
    {
        ...
        public Form1(PresentationModel presentationModel)
        {
            ...
            // 建立data binding
            start.DataBindings.Add("Enabled", pModel, "IsStartEnabled");
            next.DataBindings.Add("Enabled", pModel, "IsNextEnabled");
            numberQuestions.DataBindings.Add("Enabled", pModel, "IsNQEnabled");
            question.DataBindings.Add("Text", pModel, "Question");
        }
